...
BETWEEN SAMPLES (OBS-37). THE KEY3 MANUAL TEST WAS NOT COMPLETED AS WRITTEN: §1 WAS PARTLY WALKED — 1.1
AND 1.3–1.5 PASS, 1.2 PASSES ON ITS CRITERIA BUT THE PANIC DRAWS NOTHING WHEN
NOTHING IS PARKED AND THE PRESS DURATION WAS NOT MEASURED — WHILE §2, §3 AND
§4.1–4.3 ARE NOT EXERCISED. A SIX-HOUR UNATTENDED PASSIVE OBSERVATION COMPLETED WITH NO
