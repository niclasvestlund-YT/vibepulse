 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font src/IBMPlexSans-Bold.ttf --size 64 --bpp 4 --format lvgl --no-compress --range 0x53,0x54 -o plex_icon_64.c
 ******************************************************************************/
...
{
    {
        .range_start = 83, .range_length = 2, .glyph_id_start = 1,
