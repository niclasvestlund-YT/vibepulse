 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font src/IBMPlexSans-Bold.ttf --size 64 --bpp 4 --format lvgl --no-compress --range 0x53,0x54,0x56 -o plex_icon_64.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 639, .box_w = 35, .box_h = 47, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 823, .adv_w = 598, .box_w = 35, .box_h = 46, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1628, .adv_w = 666, .box_w = 41, .box_h = 46, .ofs_x = 0, .ofs_y = 0}
};
...
{
    {
        .range_start = 83, .range_length = 4, .glyph_id_start = 1,
