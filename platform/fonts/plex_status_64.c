 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font src/IBMPlexSans-Bold.ttf --size 64 --bpp 4 --format lvgl --no-compress --range 0x41,0x42,0x45,0x46,0x4A,0x4B,0x4C,0x4E,0x4F,0x52,0x54,0x56,0xC4 -o plex_status_64.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1817, .adv_w = 622, .box_w = 32, .box_h = 46, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2553, .adv_w = 599, .box_w = 31, .box_h = 46, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 3266, .adv_w = 572, .box_w = 31, .box_h = 46, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 3979, .adv_w = 713, .box_w = 40, .box_h = 46, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 4899, .adv_w = 543, .box_w = 28, .box_h = 46, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5543, .adv_w = 741, .box_w = 38, .box_h = 46, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 6417, .adv_w = 731, .box_w = 40, .box_h = 47, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 7357, .adv_w = 690, .box_w = 37, .box_h = 46, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 8208, .adv_w = 598, .box_w = 35, .box_h = 46, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 9013, .adv_w = 666, .box_w = 41, .box_h = 46, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 9956, .adv_w = 701, .box_w = 42, .box_h = 60, .ofs_x = 1, .ofs_y = 0}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x1, 0x4, 0x5, 0x9, 0xa, 0xb, 0xd,
    0xe, 0x11, 0x13, 0x15, 0x83
};
...
static const int8_t kern_class_values[] =
{
    ...
    -27, -29, 0, -20, 0, 0, 0, -89,
    -77, -31, 0, 0, -22, -12, 0, 0,
    0, 0, -20, -41, -26, -26, 17, 0,
    -41, -76, -74, 0, -36, -10, -25, -31
};
