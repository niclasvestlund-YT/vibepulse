 ...
 * Size: 118 px
 * Bpp: 4
 * Opts: --font platform/fonts/src/IBMPlexSans-Bold.ttf --size 118 --bpp 4 --format lvgl --no-compress --range 0x30-0x39,0x20,0x25,0x2E,0xA0,0x2013 -o platform/fonts/plex_num_118.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 31063, .adv_w = 446, .box_w = 0, .box_h = 0, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 31063, .adv_w = 1110, .box_w = 62, .box_h = 15, .ofs_x = 4, .ofs_y = 29}
};
