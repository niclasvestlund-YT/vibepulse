 ...
 * Size: 118 px
 * Bpp: 4
 * Opts: --font src/IBMPlexSans-Bold.ttf --size 118 --bpp 4 --format lvgl --no-compress --range 0x30-0x39,0x20,0xA0,0x2013 -o plex_num_118.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1133, .box_w = 65, .box_h = 85, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2763, .adv_w = 1133, .box_w = 65, .box_h = 82, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5428, .adv_w = 1133, .box_w = 62, .box_h = 84, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 8032, .adv_w = 1133, .box_w = 63, .box_h = 85, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 10710, .adv_w = 1133, .box_w = 65, .box_h = 83, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 13408, .adv_w = 1133, .box_w = 62, .box_h = 84, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 16012, .adv_w = 1133, .box_w = 63, .box_h = 84, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 18658, .adv_w = 1133, .box_w = 59, .box_h = 83, .ofs_x = 6, .ofs_y = 0},
    {.bitmap_index = 21107, .adv_w = 1133, .box_w = 63, .box_h = 85, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 23785, .adv_w = 1133, .box_w = 62, .box_h = 83, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 26358, .adv_w = 446, .box_w = 0, .box_h = 0, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 26358, .adv_w = 1110, .box_w = 62, .box_h = 15, .ofs_x = 4, .ofs_y = 29}
};
